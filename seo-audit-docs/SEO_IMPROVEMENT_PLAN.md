...
- [ ] 第四批 20 組待建候選已列於 `seo-audit-docs/ROUTE_PAGE_BACKLOG.md` 第 5 節，
      全部是高鐵（臺南／嘉義縱貫線城市對、彰化／雲林／苗栗新站）；台鐵剩下的缺口
      只有通勤短跳與支線小站，不宜再展開。該批是資料驅動展開的最後一批，之後改由
      Search Console 實際 query 報表決定。
